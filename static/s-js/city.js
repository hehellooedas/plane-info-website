...
Vcity.allCity = ['北京|beijing|bj', '上海|shanghai|sh', '重庆|chongqing|cq', '深圳|shenzhen|sz', '广州|guangzhou|gz', '杭州|hangzhou|hz',
    ...
    '厦门|xiamen|xm', '西安|xian|xa', '长沙|changsha|cs', '合肥|hefei|hf','朝阳|chaoyang|cy',
  '北海|beihai|bh',  '长春|changchun|cc', '常州|changzhou|cz',
     '常德|changde|cd', '大同|datong|dt', '大连|dalian|dl',
    '大理|dali|dl','义乌|yiwu|yw',
    '哈尔滨|haerbin|heb','承德|chengde|cd',
     '九江|jiujiang|jj',  '济南|jinan|jn',
    '唐山|tangshan|ts',
    '宜宾|yibin|yb','扬州|yangzhou|yz',
    '洛阳|luoyang|ly','武汉|wuhan|wh',
     '南宁|nanning|nn', '南阳|nanyang|ny', '南通|nantong|nt',
    '宁波|ningbo|nb', '攀枝花|panzhihua|pzh', '衢州|quzhou|qz',
     '沈阳|shenyang|sy',
     '威海|weihai|wh',  '无锡|wuxi|wx',
    '温州|wenzhou|wz', '乌鲁木齐|wulumuqi|wlmq',
    '西双版纳|xishuangbanna|xsbn',
    '烟台|yantai|yt',  '珠海|zhuhai|zh',
     '舟山|zhoushan|zs', '郑州|zhengzhou|zz'];
...
Vcity.CitySelector.prototype = {
    ...
    initialize: function (options) {
        ...
        this.input = Vcity._m.$('.'+input)[site];
        this.inputEvent();
    },
...
var test = new Vcity.CitySelector({ input: 'citySelect',site:0});
var test = new Vcity.CitySelector({ input: 'citySelect1',site:0});
var test= new Vcity.CitySelector({ input: 'city_first',site:0 });
var test= new Vcity.CitySelector({ input: 'city_second',site:0 });
